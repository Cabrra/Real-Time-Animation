...
#ifdef BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("Skinning - EXAMPLE");
#else // UNICODE
    const char szGameName[] = TEXT("Skinning - EXAMPLE");
#endif // UNICODE
#else // BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("Skinning");
#else // UNICODE
    const char szGameName[] = TEXT("Skinning");
#endif // UNICODE
#endif // BUILD_EXAMPLE
