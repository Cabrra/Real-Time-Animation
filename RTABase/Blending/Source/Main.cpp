...
#ifdef BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("RTA Animation Blending - EXAMPLE");
#else // UNICODE
    const char szGameName[] = TEXT("RTA Animation Blending - EXAMPLE");
#endif // UNICODE
#else // BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("RTA Animation Blending");
#else // UNICODE
    const char szGameName[] = TEXT("RTA Animation Blending");
#endif // UNICODE
#endif // BUILD_EXAMPLE
...
void ResizeContextGL(int nWidth, int nHeight)
	{
        ...
        EDApp::GetInstance().GetCamera( ).SetProjectionPerspective( 45.0f, nWidth, nHeight, 0.1f, 300.0f );
	}
