...
#ifdef BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("Articulated - EXAMPLE");
#else // UNICODE
    const char szGameName[] = TEXT("Articulated - EXAMPLE");
#endif // UNICODE
#else // BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("Articulated");
#else // UNICODE
    const char szGameName[] = TEXT("Articulated");
#endif // UNICODE
#endif // BUILD_EXAMPLE
