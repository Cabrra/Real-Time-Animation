...
#ifdef BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("RTA Anim Importer - EXAMPLE");
#else // UNICODE
    const char szGameName[] = TEXT("RTA Anim Importer - EXAMPLE");
#endif // UNICODE
#else // BUILD_EXAMPLE
#ifdef UNICODE
    const wchar_t szGameName[] = TEXT("RTA Anim Importer");
#else // UNICODE
    const char szGameName[] = TEXT("RTA Anim Importer");
#endif // UNICODE
#endif // BUILD_EXAMPLE
